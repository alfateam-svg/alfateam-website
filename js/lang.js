...
const DICT = {
  ...
  hero_eyebrow:   { en: "Real Estate — Oradea, Romania", ro: "Imobiliare — Oradea, România" },
  hero_title:     { en: "We search. You choose.", ro: "Noi căutăm. Tu alegi." },
  hero_lead:      { en: "We track down the industrial, commercial and residential spaces worth your time in Oradea — you decide which one's right.", ro: "Găsim spațiile industriale, comerciale și rezidențiale care merită atenția ta în Oradea — tu decizi care ți se potrivește." },
  ...
  stat_2_label:   { en: "Years active", ro: "Ani de activitate" },
  ...
  footer_tagline: { en: "Commercial, industrial & residential real estate in Oradea.", ro: "Imobiliare comerciale, industriale și rezidențiale în Oradea." },
